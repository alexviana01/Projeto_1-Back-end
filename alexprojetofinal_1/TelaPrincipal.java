...
public class TelaPrincipal extends javax.swing.JFrame {
 ...
 private final ClienteMapDAO clienteDAO = new ClienteMapDAO();
    ...
    private void BTNSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTNSalvarActionPerformed
        ...
        return; // Impede a continuidade do cadastro se houver campos vazios
    }
    ...
    Boolean isCadastrado = clienteDAO.cadastrar(cliente);
        ...
        Tabela_Principal.repaint();
        Tabela_Principal.revalidate();
        
         System.out.println("Adicionado à tabela: Nome: " + cliente.getNome() + " | CPF: " + cliente.getCpf());

        
        
                JOptionPane.showMessageDialog(null, "Cliente cadastrado com sucesso!\nNome: " + cliente.getNome() + "\nCPF: " + cliente.getCpf(), "Sucesso", JOptionPane.INFORMATION_MESSAGE);
        
        limparCampos();{JOptionPane.showMessageDialog(null, "Cliente já se encontra cadastrado", "ATENÇÃO", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    private void btn_ExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ExcluirActionPerformed
       ...
       if (linhaSelecionada >= 0) {
            ...
            if(result == JOptionPane.YES_OPTION){
                ...
                Long cpf = (Long) Tabela_Principal.getValueAt(linhaSelecionada, 1);
